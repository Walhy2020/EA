...
assert.strictEqual(normalizedFromSettings.sourceVersion, "V0010");
...
assert.strictEqual(scanSummary.rules.requiredFieldRuleVersion, "10.0.0");
assert.strictEqual(scanSummary.rules.requiredFieldRuleSourceVersion, "V0010");
