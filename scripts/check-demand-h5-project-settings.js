...
assert(/demand-project-settings\.js\?v=0\.3\.9[\s\S]*demand-required-field-display\.js\?v=0\.3\.9[\s\S]*demand-h5\.js\?v=0\.3\.9/.test(html), "项目设置和字段说明模块必须先于主页面脚本加载");
assert(js.includes('const H5_PAGE_VERSION = "0.3.9"'), "页面请求必须携带最新版本号");
assert(html.includes('demand-required-field-display.js?v=0.3.9'), "字段异常说明模块必须使用当前版本加载");
