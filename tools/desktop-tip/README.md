...
EA 服务端 desktopTip 模块版本：0.3.2；当前客户端 v0.3.4 保持不变。本轮新增后台普通消息可选“同时发送企业微信群”，群必须先通过 1号机器人真实群回调绑定。
...
现有 v0.2.3 客户端不含更新器，第一次需要手动替换到 v0.3.0 或更高版本、或重新发首次安装包。从 v0.3.0 起后续可在线更新；已在 v0.3.0 及以上的同事可在软件右键菜单选择“检查更新”升级到 v0.3.4。
...
预期输出包含 `EA 桌面提醒 v0.3.4 self test passed`，并且中文显示正常。
